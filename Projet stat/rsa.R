...
g <- ggplot(df_pct, aes(x=pct_rsa, y=score)) + 
  ...
  labs(title="Le vote en fonction de la part des alocataires du RSA", y="Part des suffrages exprimés", x="Centiles de la part des alocataires du RSA dans les communes", caption="Source : INSEE RP 2018/ Ministère de l'intérieur")+
...
g
ggsave(g, file="RSA lignes.png", type="cairo-png", dpi = 300, width = 20, height = 15, units = "cm")
